 ...
 */
const IDENTITY_PROVIDER_PROTOCOL: string = 'http'
const IDENTITY_PROVIDER_HOST: string = 'localhost'
const IDENTITY_PROVIDER_PORT: string = '9000'
const IDENTITY_PROVIDER_KEYCLOAK_REALM: string = 'lab4-web'
const IDENTITY_PROVIDER_CLIENT: string = 'lab4-web-client'
...
/*
  API CONFIGURATION
 */
const ATTEMPT_API_PROTOCOL: string = 'http'
const ATTEMPT_API_HOST: string = 'localhost'
const ATTEMPT_API_PORT: string = '8090'
